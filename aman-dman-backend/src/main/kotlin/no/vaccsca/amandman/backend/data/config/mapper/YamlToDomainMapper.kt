package no.vaccsca.amandman.backend.data.config.mapper

import no.vaccsca.amandman.backend.data.config.yaml.AircraftPerformanceYaml
import no.vaccsca.amandman.backend.data.config.yaml.AirportJson
import no.vaccsca.amandman.backend.data.config.yaml.AmanDmanSettingsYaml
import no.vaccsca.amandman.backend.data.config.yaml.MasterSlaveApiConnectionParamsYaml
import no.vaccsca.amandman.backend.data.config.yaml.AtcClientConnectionParamsYaml
import no.vaccsca.amandman.backend.data.config.yaml.ConnectionConfigYaml
import no.vaccsca.amandman.backend.data.config.yaml.LabelItemAlignmentEnumYaml
import no.vaccsca.amandman.backend.data.config.yaml.LabelItemSourceEnumYaml
import no.vaccsca.amandman.backend.data.config.yaml.LabelItemYaml
import no.vaccsca.amandman.backend.data.config.yaml.SideYaml
import no.vaccsca.amandman.backend.data.config.yaml.StarYamlEntry
import no.vaccsca.amandman.backend.data.config.yaml.StarYamlFile
import no.vaccsca.amandman.backend.data.config.yaml.TimelineYaml
...
import no.vaccsca.amandman.common.domain.valueobjects.SharedStateConnectionParameters
import no.vaccsca.amandman.common.domain.valueobjects.AtcClientConnectionParameters
import no.vaccsca.amandman.common.domain.valueobjects.ConnectionConfig
...
import no.vaccsca.amandman.common.domain.valueobjects.Side
import no.vaccsca.amandman.common.domain.valueobjects.Timeline
