import { listConfigAirportTimelines } from '@/src/features/config-read/service';
...
export const GET = withErrorHandling(
  async (
    ...
    return jsonResponse(await listConfigAirportTimelines(getConfigRepository(), subdivision, icao));
  }
);
