import { listConfigAirportHorizons } from '@/src/features/config-read/service';
...
export const GET = withErrorHandling(
  async (
    ...
    return jsonResponse(await listConfigAirportHorizons(getConfigRepository(), subdivision, icao));
  }
);
