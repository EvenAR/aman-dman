import { listConfigSubdivisionAirports } from '@/src/features/config-read/service';
...
export const GET = withErrorHandling(
  async (
    ...
    return jsonResponse(await listConfigSubdivisionAirports(getConfigRepository(), subdivision));
  }
);
